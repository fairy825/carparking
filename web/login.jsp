            ...
            <center>
                <div  style="text-align: left">
                    <form class="form-signin" method="get" action="forelogin">
                        ...
                        <label style="color: mintcream">验证码</label>
                        <input type="text" class="form-control" placeholder="请输入验证码" required autofocus/><br>
                        <img alt="验证码" id="imagecode" src="static/img/checkcode.PNG" th:src="@{~/img/checkcode.PNG}">&nbsp;&nbsp;&nbsp;
                        <a  style="color: mintcream;font-family: 'Courier New', Courier, monospace">看不清楚</a><br>
    ...
    <div class="container">
        <div class="row">
            <div class="main-menu">
                <ul>
                    <li>
                        <a href="http://localhost:8080/user/login">用户</a>
                    </li>
                    <li>
                        <a href="http://localhost:8080/admin/login">管理员</a>
                    </li>
